...
export default function AdminProfile() {
  const { profile, role, refreshProfile, changePassword } = useAuth();
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <span className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded text-xs font-medium bg-primary/10 text-primary">
